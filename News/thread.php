...
<head>
    ...
    <title>welcome to Blade News</title>
...
<?php  
   ...
   ?>
    ...
    <div class="container jumbotron">
        ...
        <img src="images/<?php echo $image;?>" class="img-thumbnail" alt="could'nt load image">
            
            <p class="lead pt-3"><?php echo $desc;?></p>
            <hr class="my-4">
            <p>-posted by <b><?php echo "Blade News";?></b></p>
 ...
 if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    ...
    <p class="text-danger">Your are not logged in.Please login to post comments!!</p>
    </div>';
 }
        ...
        <?php
         ...
         while($row=mysqli_fetch_assoc($result)){
          ...
          echo'<div class="media my-3">
            ...
            <p class="my-0">commented time-<b>'. $comment_time.'</b></p>
